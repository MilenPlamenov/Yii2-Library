...
<div class="card mb-3 border-primary">
    <div class="card-body">
        <h1 class="card-title">User: <?= $model->user->email ?></h1>
        <h3>Book: <?= $model->book->title ?> (amount:<?= $model->amount ?>)</h3>
        <h4 class="text-decoration-underline">Date: <?= $model->booked_date ?></h4>
        <hr/>
        <h2 class="text-center m-4"><?= Html::a(Html::encode('Order now '. $model->book->title),
